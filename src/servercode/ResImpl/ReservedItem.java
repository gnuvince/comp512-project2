...
public class ReservedItem extends RMItem {
    ...
    public String toString() {
        return "hashkey='" + getKey() + "', reservableItemKey='"
            + getReservableItemKey() + "', count='" + getCount() + "', price='"
            + getPrice() + "'";
    }

    // NOTE: hashKey is the same as the ReservableItem hashkey--this would have
    // to change if we
